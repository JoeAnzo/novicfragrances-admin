...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Delete Products", path: "/products/delete", pro: false },
      { name: "View Products", path: "/products", pro: false },
    ],
  },
  {
    name: "Orders",
  ...
  },
  {
    ...
    icon: <BoxCubeIcon />,
    subItems: [
      { name: "Inventory Overview", path: "/inventory", pro: false },
      { name: "Add Inventory", path: "/inventory/add", pro: false },
      { name: "Low Stock", path: "/inventory/low-stock", pro: false },
    ],
  },
  {
    name: "Payments",
    ...
    subItems: [
      ...
      { name: "Failed Payments", path: "/payments/failed", pro: false },
    ],
  },
];
      ...
      >
        <Link to="/">
            <div className="text-center lg:text-left">
              ...
              {(isExpanded || isHovered || isMobileOpen) && (
                <p className="text-xs uppercase tracking-widest text-gray-400 dark:text-white">
                  fragrances
                </p>
              )}
            </div>
